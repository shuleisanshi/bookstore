				...
				<td style="padding:30px; text-align:center"><table width="60%"
						...
						<tr>
							...
							<td style="padding-top:30px"><font
								style="font-weight:bold; color:#FF0000">Account successfully activated</font><br /> <br />
								<a href="index.jsp"><span id="second">5</span>second before return homepage</a></td>
						</tr>
					</table>
					<h1>&nbsp;</h1></td>
			</tr>
